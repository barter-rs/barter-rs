...
use jackbot_instrument::{exchange::ExchangeId, index::error::IndexError};
use jackbot_integration::{error::SocketError, subscription::SubscriptionId};
use serde::{Deserialize, Serialize};
use thiserror::Error;

/// All errors generated in `jackbot-data`.
