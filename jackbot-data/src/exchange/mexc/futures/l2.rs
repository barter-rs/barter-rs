//! Level 2 order book types for MEXC futures.
use crate::{
    Identifier,
...
pub struct MexcFuturesOrderBookL2 {
    #[serde(alias = "symbol")]
...
impl Identifier<Option<SubscriptionId>> for MexcFuturesOrderBookL2 {
    fn id(&self) -> Option<SubscriptionId> {
        Some(self.subscription_id.clone())
    }
}

impl Canonicalizer for MexcFuturesOrderBookL2 {
...
impl<InstrumentKey> From<(ExchangeId, InstrumentKey, MexcFuturesOrderBookL2)>
    for MarketIter<InstrumentKey, OrderBookEvent>
{
    fn from((exchange_id, instrument, book): (ExchangeId, InstrumentKey, MexcFuturesOrderBookL2)) -> Self {
...
mod tests {
    ...
    #[test]
    fn test_mexc_futures_order_book_l2() {
        let input = r#"{\"symbol\":\"BTC_USDT\",\"bids\":[[\"30000.0\",\"1.0\"]],\"asks\":[[\"30010.0\",\"2.0\"]]}"#;
        let book: MexcFuturesOrderBookL2 = serde_json::from_str(input).unwrap();
