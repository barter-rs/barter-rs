...
pub trait MarketUpdater<T> {
    ...
    /// changes.
    fn update_from_market<InstrumentId>(
        &mut self,
...
pub struct OrderEvent<InstrumentId> {
...
impl<InstrumentId> OrderEvent<InstrumentId> {
    ...
    pub fn builder() -> OrderEventBuilder<InstrumentId> {
...
pub struct OrderEventBuilder<InstrumentId> {
...
impl<InstrumentId> OrderEventBuilder<InstrumentId> {
    pub fn new() -> Self {
        Self::default()
    }
    ...
    pub fn build(self) -> Result<OrderEvent<InstrumentId>, PortfolioError> {
        Ok(OrderEvent {
