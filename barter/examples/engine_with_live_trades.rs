...
use tracing::warn;
use uuid::Uuid;
use barter_metrics::metrics::{METRIC_ENGINE_TRADER_SIGNAL_COUNT, METRIC_ENGINE_TRADER_SIGNAL_LATENCY};
...
async fn main() {
    ...
    traders.push(
        Trader::builder()
            ...
            .data(live::ReconnectingMarketFeed::new(
                stream_market_event_trades().await,
            ))
