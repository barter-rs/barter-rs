...
const CONFIG_PATH: &str = "Jackbot/examples/config/backtest_config.json";
const FILE_PATH_MARKET_DATA_INDEXED: &str =
    "Jackbot/examples/data/binance_spot_trades_l1_btcusdt_ethusdt_solusdt.json";
