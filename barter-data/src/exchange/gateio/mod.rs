...
use book::{l1::GateioOrderBookL1, l2::GateioOrderBookL2};
use serde_json::json;
...
impl<Instrument, Server> StreamSelector<Instrument, OrderBooksL2> for Gateio<Server>
where
    Instrument: InstrumentData,
    Server: ExchangeServer + Debug + Send + Sync,
{
    type SnapFetcher = NoInitialSnapshots;
    type Stream = ExchangeWsStream<
        StatelessTransformer<Self, Instrument::Key, OrderBooksL2, GateioOrderBookL2>,
    >;
}
