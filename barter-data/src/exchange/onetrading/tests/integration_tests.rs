...
use futures_util::{StreamExt, stream::StreamExt as FuturesStreamExt};
...
mod tests {
    ...
    async fn test_onetrading_public_trades() {
        ...
        // Initialize OneTrading Trades stream
        let streams = Streams::<PublicTrades>::builder()
            ...
            .init()
            .await
            .expect("Failed to initialize OneTrading streams");
    ...
    async fn test_onetrading_orderbook_l1() {
        ...
        // Initialize OneTrading L1 Orderbook stream
    ...
    async fn test_onetrading_orderbook_l2() {
        ...
        // Initialize OneTrading L2 Orderbook stream
