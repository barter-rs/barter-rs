...
use barter_integration::{serde::de::util::extract_next, subscription::SubscriptionId};
...
pub struct KrakenSpread {
    ...
    #[serde(
        deserialize_with = "barter_integration::serde::de::util::de_str_f64_epoch_s_as_datetime_utc"
    )]
