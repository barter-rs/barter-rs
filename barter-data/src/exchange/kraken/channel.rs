...
impl_channel_identifier!(Kraken, Instrument => KrakenChannel, PublicTrades => KrakenChannel::TRADES);
impl_channel_identifier!(Kraken, Instrument => KrakenChannel, OrderBooksL1 => KrakenChannel::ORDER_BOOK_L1);
