...
impl<Instrument> DataStream<LiveMarketDataArgs<Self, Instrument, PublicTrades>> for Bitmex
where
    Instrument: InstrumentData + 'static,
    Subscription<Self, Instrument, PublicTrades>: Identifier<BitmexMarket>,
{
