...
pub struct CoinbaseOrderBookL1 {
  ...
  pub kind: String,
  pub sequence: u64,
  #[serde(rename(deserialize = "product_id"), deserialize_with = "de_ob_l1_subscription_id")]
  pub subscription_id: SubscriptionId,
  #[serde(rename(deserialize = "best_bid"), deserialize_with = "barter_integration::de::de_str")]
  pub best_bid_price: f64,
  #[serde(rename(deserialize = "best_bid_size"), deserialize_with = "barter_integration::de::de_str")]
  pub best_bid_amount: f64,
  #[serde(rename(deserialize = "best_ask"), deserialize_with = "barter_integration::de::de_str")]
  pub best_ask_price: f64,
  #[serde(rename(deserialize = "best_ask_size"), deserialize_with = "barter_integration::de::de_str")]
