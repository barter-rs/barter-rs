...
pub struct DynamicStreams<InstrumentId> {
    pub trades:
        VecMap<ExchangeId, UnboundedReceiverStream<MarketStreamEvent<InstrumentId, PublicTrade>>>,
    pub l1s:
        VecMap<ExchangeId, UnboundedReceiverStream<MarketStreamEvent<InstrumentId, OrderBookL1>>>,
    pub l2s: VecMap<
        ExchangeId,
        UnboundedReceiverStream<MarketStreamEvent<InstrumentId, OrderBookEvent>>,
    >,
    pub liquidations:
        VecMap<ExchangeId, UnboundedReceiverStream<MarketStreamEvent<InstrumentId, Liquidation>>>,
}
...
impl<InstrumentKey> DynamicStreams<InstrumentKey> {
    ...
    pub fn select_trades(
        &mut self,
        exchange: ExchangeId,
    ) -> Option<UnboundedReceiverStream<MarketStreamEvent<InstrumentKey, PublicTrade>>> {
    ...
    pub fn select_all_trades(
        &mut self,
    ) -> SelectAll<UnboundedReceiverStream<MarketStreamEvent<InstrumentKey, PublicTrade>>> {
    ...
    pub fn select_l1s(
        &mut self,
        exchange: ExchangeId,
    ) -> Option<UnboundedReceiverStream<MarketStreamEvent<InstrumentKey, OrderBookL1>>> {
    ...
    pub fn select_all_l1s(
        &mut self,
    ) -> SelectAll<UnboundedReceiverStream<MarketStreamEvent<InstrumentKey, OrderBookL1>>> {
    ...
    pub fn select_l2s(
        &mut self,
        exchange: ExchangeId,
    ) -> Option<UnboundedReceiverStream<MarketStreamEvent<InstrumentKey, OrderBookEvent>>> {
    ...
    pub fn select_all_l2s(
        &mut self,
    ) -> SelectAll<UnboundedReceiverStream<MarketStreamEvent<InstrumentKey, OrderBookEvent>>> {
    ...
    pub fn select_liquidations(
        &mut self,
        exchange: ExchangeId,
    ) -> Option<UnboundedReceiverStream<MarketStreamEvent<InstrumentKey, Liquidation>>> {
    ...
    pub fn select_all_liquidations(
        &mut self,
    ) -> SelectAll<UnboundedReceiverStream<MarketStreamEvent<InstrumentKey, Liquidation>>> {
    ...
    where
        ...
        Output: 'static,
        MarketStreamEvent<InstrumentKey, PublicTrade>: Into<Output>,
        MarketStreamEvent<InstrumentKey, OrderBookL1>: Into<Output>,
        MarketStreamEvent<InstrumentKey, OrderBookEvent>: Into<Output>,
        MarketStreamEvent<InstrumentKey, Liquidation>: Into<Output>,
    {
        let Self {
            trades,
            l1s,
        ...
        let trades = trades
            .into_values()
            .map(|stream| stream.map(MarketStreamEvent::into).boxed());
...
struct Txs<InstrumentKey> {
    trades: FnvHashMap<
        ExchangeId,
        mpsc::UnboundedSender<MarketStreamEvent<InstrumentKey, PublicTrade>>,
    >,
    l1s: FnvHashMap<
        ExchangeId,
        mpsc::UnboundedSender<MarketStreamEvent<InstrumentKey, OrderBookL1>>,
    >,
    l2s: FnvHashMap<
        ExchangeId,
        mpsc::UnboundedSender<MarketStreamEvent<InstrumentKey, OrderBookEvent>>,
    >,
    liquidations: FnvHashMap<
        ExchangeId,
        mpsc::UnboundedSender<MarketStreamEvent<InstrumentKey, Liquidation>>,
    >,
}
...
struct Rxs<InstrumentKey> {
    trades: FnvHashMap<
        ExchangeId,
        mpsc::UnboundedReceiver<MarketStreamEvent<InstrumentKey, PublicTrade>>,
    >,
    l1s: FnvHashMap<
        ExchangeId,
        mpsc::UnboundedReceiver<MarketStreamEvent<InstrumentKey, OrderBookL1>>,
    >,
    l2s: FnvHashMap<
        ExchangeId,
        mpsc::UnboundedReceiver<MarketStreamEvent<InstrumentKey, OrderBookEvent>>,
    >,
    liquidations: FnvHashMap<
        ExchangeId,
        mpsc::UnboundedReceiver<MarketStreamEvent<InstrumentKey, Liquidation>>,
    >,
}
