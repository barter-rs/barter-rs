...
use barter_integration::channel::{mpsc_unbounded, UnboundedTx};
use barter_integration::protocol::websocket::{connect, WebSocket, WsMessage, WsSink};
use barter_integration::socket::{Processor, Socket, SocketManager};
use barter_integration::stream::merge::merge;
use barter_integration::subscription::SubscriptionId;
use crate::subscription::Subscription;

const URL: &str = "wss://streams.fast.onetrading.com";

pub type Initialised<Stream, Update> = (
    Stream,
    UnboundedTx<Update>
);
